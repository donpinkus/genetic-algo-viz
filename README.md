...
Controls the # of people in the population.
...
This controls how genes between a mother and a father are mixed.

1. Half n half: takes half genes from mother, half from father, splitting in the middle of their DNA.

2. Every other: Switches off every other gene

3. Random chunks: Switches off at random chunks

4. Smart: More genes taken from the fitter parent by what % fitter they are.
